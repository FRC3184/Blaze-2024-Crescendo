...
import frc.robot.GitRepoImports.RevMaxSwerve.constantsMaxSwerve.ModuleConstants;
...
public class MAXSwerveModuleWithSparkFlex {
  ...
  private final CANSparkFlex m_turningSpark;
   ...
   * Encoder.
   */
  public MAXSwerveModuleWithSparkFlex(int drivingCANId, int turningCANId, double chassisAngularOffset) {
    m_drivingSpark = new CANSparkFlex(drivingCANId, MotorType.kBrushless);
    m_turningSpark = new CANSparkFlex(turningCANId, MotorType.kBrushless);
